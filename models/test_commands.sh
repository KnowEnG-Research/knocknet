...
#python3 serialize_features.py /home/tfuser/data/test_tsv/ /home/tfuser/data/test_tfrecord/ --label_col 7
...
CMD="python3 models.py --data_dir /home/tfuser/data/test_tfrecord/ --data_serialized --out_label_count 10 \
